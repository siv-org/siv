...
1. In your [**Election Admin Dashboard**](https://login.siv.tech), navigate to the **`Voters`** tab.

2. Check the box(es) for the voter(s) you want to invalidate.

3. In the top-left corner above the Voters table, click the trash can icon: 🗑️
...
Invalidated voter can still be revalidated again, to undo any mistakes.
