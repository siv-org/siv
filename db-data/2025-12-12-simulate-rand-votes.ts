...
Execute it w/:
    npx tsx db-data/2025-12-12-simulate-rand-votes.ts
*/
...
const election_id = '1765523980838'
...
const create_and_store_random_votes = async (voters: string[]) => {
...
const generateVoters = (amount: number): string[] => {
  return Array(amount)
    .fill(0)
    .map(() => generateAuthToken())
}
