    ...
    <>
      ...
      <main>
        <div>
          ...
          {election_title && (
            <div>
              <h2 className="mb-1">{election_title}</h2>

              {/* View Ballot */}
              <a
                className="text-sm font-normal inline-block p-1.5 -ml-1.5 text-black opacity-30 border rounded-lg transition duration-300 hover:opacity-100 hover:no-underline border-solid border-black/0 hover:border-black/30"
