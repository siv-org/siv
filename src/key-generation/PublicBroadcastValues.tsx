...
export const PublicBroadcastValues = () => (
  <>
    <h3>V. Public Broadcast Values:</h3>
    <p>
      Each trustee broadcasts public commitments A<sub>0</sub>, ..., A<sub>t-1</sub> from their private coefficients, g
      ^ a % p
    </p>
    <Private>
      <p>Calculating your public commitments...</p>
      <p>
        A<sub>0</sub> = 4 ^ 15 % 59 ≡ 49
      </p>
      <p>
        A<sub>1</sub> = 4 ^ 21 % 59 ≡ 7
      </p>
      <p>
        A<sub>2</sub> = 4 ^ 9 % 59 ≡ 1
      </p>
    </Private>
    <ol>
