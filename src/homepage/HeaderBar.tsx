...
export const HeaderBar = () => {
  ...
  const signInLink = `${baseLink} no-underline hover:no-underline text-indigo-900 border shadow-md bg-white/60 bg-gradient-to-r from-indigo-100/60 to-white/60 backdrop-blur-md border-white/50 hover:bg-white/80 hover:from-indigo-200/80 hover:shadow-lg`
