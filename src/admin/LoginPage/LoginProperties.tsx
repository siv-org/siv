...
export function LoginProperties() {
  return (
    <section className="px-7 py-14 md:py-20 mx-auto max-w-[720px]">
      <ScrollReveal>
        <h2 className="font-serif26 text-[clamp(1.35rem,3vw,1.75rem)] font-normal tracking-tight text-h26-text text-center">
          What you get with SIV
        </h2>
        <ul className="grid gap-6 pl-0 mt-10 list-none sm:grid-cols-1">
