  ...
  return (
    <section className="px-7 pt-[11rem] pb-36 text-center md:pt-[12.5rem] md:pb-44 mx-auto max-w-[920px]">
      ...
      <div className="animate-[fadeInUp_0.9s_ease-out_both]">
        ...
        <span className="mt-8 block font-sans text-[clamp(0.8rem,1.5vw,0.95rem)] font-medium uppercase tracking-[0.2em] text-h26-blue/90">
          even for the highest stakes environments
        </span>
      </div>

      {/* Social proof */}
      <p className="mx-auto mt-4 max-w-md text-[clamp(0.7rem,1.25vw,0.82rem)] tracking-[0.12em] leading-[1.7] text-h26-textSecondary/95 animate-[fadeInUp_0.9s_0.2s_ease-out_both]">
        <Globe className="inline size-[1.1em] align-[-0.2em] text-h26-green/90 mr-[5px]" />
