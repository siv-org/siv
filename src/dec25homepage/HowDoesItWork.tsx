...
export const HowDoesItWork = () => {
  ...
  return (
    <div className="w-full max-w-[23rem]">
      <button
        className={`p-2 w-full font-medium bg-sky-100 rounded-md text-black/75 hover:bg-gradient-to-b hover:from-sky-200 hover:to-sky-100 active:from-sky-300 active:to-sky-200 select-none border-2 border-sky-200 hover:border-sky-300/80 hover:text-black ${
